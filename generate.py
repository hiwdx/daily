...
SENSITIVE_POLITICS_PATTERNS = [
    r"特朗普|Trump|拜登|Biden",
    r"美国国会|Congress|White House|白宫",
    r"(?:美国|中国).{0,8}(?:政府|国会|国务院|行政令|监管|审查|国家安全)",
    r"中美|地缘政治|制裁",
    r"涉台|台湾|香港|新疆",
]
...
- 超过 24 小时的旧新闻
- 未经证实的传言
- 涉及中国或美国核心政治敏感议题的内容，包括但不限于政府高层、党派政治、国会/行政命令、国家安全审查、地缘政治争议、涉台涉港涉疆、人权与制裁等
- 如果一条新闻的主叙事是政府监管、政策博弈或政治表态，即使与 AI 相关也不要收录；优先选择产品、工程、商业落地和开发者生态内容
...
- 严禁输出任何涉及中美核心政治敏感内容的条目、摘要、观察或来源说明；发现相关主题时必须直接跳过，改选其他新闻
                ...
                messages.append(
                    {
                        "role": "user",
                        "content": (
                            "上次输出触及禁止主题：中美核心政治敏感内容。"
                            "请完全重写整份简报，只保留产品、工程、商业落地、开发者生态相关内容，"
                            "不要保留或改写任何涉及政府、国会、行政命令、国家安全审查、地缘政治、涉台涉港涉疆、制裁的条目。"
                        ),
                    }
                )
                continue
